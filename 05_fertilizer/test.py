...
def test_that_loaded_data_has_seeds_and_maps():
...
def test_that_loaded_seeds_are_correct_for_example():
    seeds, maps = solution.load_data("example.txt")
    assert seeds == [79, 14, 55, 13]


def test_that_loaded_maps_are_correct_for_example():
    seeds, maps = solution.load_data("example.txt")
...
def test_that_loaded_ranges_are_correct_for_example():
    seeds, maps = solution.load_data("example.txt")
...
def test_that_example_seeds_are_mapped_to_correct_soil(seed, soil):
...
def test_that_example_seeds_are_mapped_to_correct_soil(seed, location):
    _, maps = solution.load_data("example.txt")
